...
module.exports = {
	...
	admin: {
		...
		validEmails: ["sofiqpanova@gmail.com"],
		// set the organization ids you want to be able to log in to the admin website
		validOrgs: [34383926706044]
	},

	// you can generally leave this as-is since it is generated for each new project you created.
	session: {
		encryptionAlgorithm: 'aes256',
		encryptionKey: 'aoBKpYh/RI6S33ywV9MOdbk9dAZu6L9kL56aSqrI130=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'eENxwIT034pxzjj2DvKBMGsFcfIVX6ljFT77mZOdDT9hMTxXFGxrMLBxcmy4SOzPs8Czigov0X6k4kJr+f7eQA==',
		secret: 'h0X9BvdACzs5RdFFwBef7lKjOMAbw9j6', // should be a large unguessable string
	...
	cookieSecret: 'lhvh3MGzPB+w9Op3kS4OfCRmK7vgnMGi',
